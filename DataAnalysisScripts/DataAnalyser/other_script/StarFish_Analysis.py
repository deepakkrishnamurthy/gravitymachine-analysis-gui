...
path="F:/GravityMachineBackup/HopkinsEmbryologyCourse/2018_06_12/Starfish/StarFish10/"
file="track.csv"
...
def find_peaks(T,Z):
    peaks=signal.find_peaks(Z,distance=100,width=100,prominence=(5,20))
    return peaks[0]

peaks=find_peaks(T,Z)
print(peaks)
DeltaTBlink=[]
...
#plt.plot(T, Z,label='trajectory rot')
plt.plot(Time,peak_indicator,label='blink')
plt.title('StarFish10: "Blink" detection')
plt.legend()
