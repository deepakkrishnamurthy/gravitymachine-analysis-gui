...
#starved with food dendraster 1 : distance=30,width=30,prominence=(0.1, 4)) #shitty
    
#starved with food dendraster 3 : distance=30,width=30,prominence=(0.05, 4))
    
#well fed dendraster 1 : distance=30,width=30,prominence=(0.1, 4))
#well fed dendraster 3 : distance=30,width=30,prominence=(0.05, 4))
...
plt.title('Dendraster1: "Blink" detection')
plt.legend()
...
plt.title('Dendraster1: "Blink" distribution')
